...
#write the code for defining radar sensor function
 def generate_radar_blueprint(get_blueprint_library):
...
try:
    ...
    sensor.listen(lambda radar_data: _r_callback(radar_data))
    #write code here for defining radar_callback function to display the data
    def _r_callback(radar_data):
        for detection in radar_data:
            print('depth :', detection.depth)
            print('aziumth :', detection.aziumth)
            print('altitude :', detection.altitude)
            print('velocity :', detection.velocity)
